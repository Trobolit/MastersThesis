...
Due to time constraints the weighing of airflow inside and outside the propeller wash could not be fully determined, but initial estimation of the parameters were enough to achieve robust, stable hovering transitioning and flying.
...
\begin{figure}[]
    \centering
    \input{pitch.tex}
    \caption{Step responses in pitch for the flying Plywood board while both hovering and flying.}
    \label{airplane}
\end{figure}

\begin{figure}[]
    \input{roll.tex}
    \caption{Step responses in roll for the flying Plywood board while both hovering and flying.}
    \label{airplane}
\end{figure}
