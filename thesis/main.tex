...
\begin{figure}
    \center
    \includegraphics[width=0.9\textwidth]{plywoodfinal.jpg}
...
Inertias have been estimated in a CAD program, and other parameters were estimated from measurements on similar aircraft.
The simulator is, any way, just a feasibility check and not a proper tuning ground for the controller, finding bugs and rough settings is enough.
...
Due to the complex nonlinear state space equations solving the system for feedback simulations was infeasible.
...
However, the decoupling matrix had a condition number in the order of $10^5$ making the system very susceptible to any noise or uncertanties.
